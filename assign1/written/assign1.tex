...
\ir{S-Num-Property}{(n \, op\, n_{1})}{\matches{n}{(\tnum<op\, n_{1}>)}}

\ir{S-String-Property}{(s \, op\, s_{1})}{\ \matches{s}{\tstr<op \, s_{1}>} }
...
\ir{Valid-Key-Accessor}{\ \matches{\{(\,s:j)^{*}\,\}}{ \tau} \,\,\, s^{'} \in s \,\,\,\, \matches{a}{\tau} }{\ \matches{.s^{'}a}{\tau}}

\ir{Valid-Array-Accessor}{ \matches{[\, j ]\,}{\tau} \,\,\,   \matches{a}{\tau}}{\ \matches{[\, n ]a\,}{\tau}}

\ir{Valid-Maps-Accessor}{ \matches{[\, j ]\,}{\tau} \,\,\, \matches{a}{\tau} }{\matches{|a}{\tau}}
