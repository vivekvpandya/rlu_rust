...
\ir{Maps-Accessor}{\ }{( \, |a, [\, j_1, ..., j_k,...,j_n ]\, )\, \mapsto (\,  [\, (a, j_1) , ..., (a,  j_k),...(a, j_n)]\,)\,]\, }
\end{mathpar}
...
\ir{Valid-Key-Accessor}{\{(\,s:j)\,\} = \tau \,\,\, \matches{s}{\tstr}  }{\ \matches{.s}{\tau}}

\ir{Valid-Array-Accessor}{ [\, j ]\, = \tau \,\,\, n \leq size \, of \, array  }{\ \matches{[\, n ]\,}{\tau}}

\ir{Valid-Maps-Accessor}{ [\, j ]\, = \tau }{\matches{|}{\tau}}
